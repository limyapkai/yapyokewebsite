        ...
        <v-container fill-height>
          <div style="max-width: 700px" class="mx-auto text-center">
            <v-avatar size="128" class="mb-7">
              <img
                :src="`/team/${item.avtar}`"
                alt="No Image (Avatar Picture not in Static"
                width="128"
                height="128"
              />
            </v-avatar>
      ...
      testimonials: [
        {
          ...
          review: '1 Lorempp ipsum dolor sit amet',
        },
        {
          avtar: 'person-8.jpg',
          name: 'Petey Cruiser',
          post: 'CEO of Json LLC',
          review: '2 Lorempp ipsum dolor sit amet',
        },
        {
          avtar: 'person-7.jpg',
          name: 'Anna Sthesia',
          post: 'Director of Cleaner LTD',
          review: '3 Lorempp ipsum dolor sit amet',
        },
        {
          avtar: 'person-10.jpg',
          name: 'Paul Molive',
          post: 'Manager of Torson LTD',
          review: '4 Lorempp ipsum dolor sit amet',
        },
        {
          avtar: 'person-9.jpg',
          name: 'Gail Forcewind',
          post: 'Human Resource Manager of Humibed LLC',
          review: '5 Lorempp ipsum dolor sit amet',
        },
      ],
    }
  },
